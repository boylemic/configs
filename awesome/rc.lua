...
--mytextclock = awful.widget.textclock("<span ciolor='red'>%H:%M/span>")
mytextclock = awful.widget.textclock("<span color='#2E9AFE'>%b-%d-%Y %H:%M</span>")
--mytextclock:set_color('#900000')
